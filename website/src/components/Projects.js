...
const Projects = () => {
    return (
       <div style={{width: '100%', gap: '20px'}}>
            ...
            <ProjectCard name="Music Tinder" photoUrl={MusicTinder}  demoLink = 'https://www.youtube.com/watch?v=VzFGb4SRqw0' description="Music Tinder is a Spotify-integrated application that gamifies music discovery by allowing users to swipe through their liked songs organized by genre. Users can select genres from their music library, then swipe left to skip or right to save songs they enjoy. The pygame application features audio streaming capabilities through YouTube for song previews and leverages the Spotify API to fetch user libraries and create custom playlists. After swiping through songs, users can automatically generate a new Spotify playlist containing all their right-swiped tracks."/>
