...
const Projects = () => {
    return (
       <div style={{width: '100%', gap: '20px'}}>
            ...
            <ProjectCard name="NYU Holodeck: High Speed Research Network" photoUrl={nyu} websiteHSRN = 'https://vip.hsrn.nyu.edu' websiteCORELINK = 'https://corelink-docs.hsrn.nyu.edu' description="Working with a selective research team to develop NYU’s Corelink in Python, building benchmarking tools for UDP, TCP, and WebSocket protocols with configurable settings to test various scenarios. Identified a critical TCP data-loss bug at high payload sizes, leading to a confirmed fix. Authored comprehensive benchmarking reports with analysis and recommendations for protocol optimization. Integrating optional server-side data processing through a modular plugin architecture, enhancing flexibility and scalability. Committing 10 hours per week to project development, including weekly stand-up meetings to track progress and goals."/>
