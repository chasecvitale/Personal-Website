    ...
    return (
       <div style={{width: '100%', gap: '20px'}}>
            <ProjectCard 
                ...
                description="FlakeMate is a full-stack event management platform I developed to solve the universal problem of chronic lateness among social groups. The system uses a microservices architecture with three containerized subsystems: a Flask web application for user interaction, an invite-adjuster backend service that calculates dynamic lateness scores, and a MongoDB database for persistent storage. The web app allows users to create accounts, schedule events, send invitations, and report attendee tardiness. The invite-adjuster algorithm then processes these lateness reports to generate personalized event times—consistently late users see earlier start times on their invitations as a behavioral nudge toward punctuality. I implemented this using Docker containers deployed on Azure Container Apps, with GitHub Actions CI/CD pipelines for each subsystem achieving 80%+ test coverage. The system handles user authentication, event CRUD operations, real-time invitation responses, and automated time adjustments. This project demonstrates my ability to architect distributed systems, manage containerized deployments, implement CI/CD automation, integrate NoSQL databases, and solve real-world social coordination problems through algorithmic adjustments."
            />
            <ProjectCard 
                name="SwipeBeats" 
                ...
                links={[
                    ...
                    ['GitHub', 'https://github.com/chasecvitale/SwipeBeats']
                ]}
            ...
            <ProjectCard 
                ...
                links={[
                    ...
                    ['GitHub', 'https://github.com/mkphung29/places2be']
                ]}
            ...
            <ProjectCard 
                ...
                photoUrl={CV}
                links={[
                    ['GitHub', 'https://github.com/chasecvitale/Personal-Website']
                ]}
