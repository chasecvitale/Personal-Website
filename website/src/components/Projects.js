...
const Projects = () => {
    return (
       <div style={{width: '100%', gap: '20px'}}>
            ...
            <ProjectCard name="NYU Holodeck: High Speed Research Network" photoUrl={nyu} websiteHSRN = 'https://vip.hsrn.nyu.edu' websiteCORELINK = 'https://corelink-docs.hsrn.nyu.edu' description="Working in the Spring 2025 semester with a selective research team of six people to develop NYU’s Corelink using Python. Integrating optional server-side data processing through a modular plugin architecture, enhancing flexibility and scalability. Committing 10 hours per week to project development, including weekly stand-up meetings on project progress and goals."/>
